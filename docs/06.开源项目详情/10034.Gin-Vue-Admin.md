---
title: Gin-Vue-Admin
date: 2023-04-17 13:34:24
permalink: /pages/10034/
sidebar: false
article: false
---
::: note 开源地址
Github：[https://www.gin-vue-admin.com/](https://www.gin-vue-admin.com/)
:::

![img](http://qmplusimg.henrongyi.top/gvalogo.jpg)

![img](https://img.shields.io/badge/golang-1.16-blue) ![img](https://img.shields.io/badge/gin-1.7.0-lightBlue) ![img](https://img.shields.io/badge/vue-3.2.25-brightgreen) ![img](https://img.shields.io/badge/element--plus-2.0.1-green) ![img](https://img.shields.io/badge/gorm-1.22.5-red)

## 不同版本

我们会对以下四个版本持续维护，请选择适合自己的版本使用。最新技术栈为组合式api版本，已支持多语言（I18N）

[组合式API版（主）](https://github.com/flipped-aurora/gin-vue-admin) | [组合式API多语言(i18n)版](https://github.com/flipped-aurora/gin-vue-admin/tree/i18n-dev-new) | [声明式API版](https://github.com/flipped-aurora/gin-vue-admin/tree/v2.4.x) | [声明式API多语言(i18n)版](https://github.com/flipped-aurora/gin-vue-admin/tree/i18n-dev)
...
![img](https://qmplusimg.henrongyi.top/%E6%8E%88%E6%9D%83.png)
...
|                     QQ 群                     |
| :-------------------------------------------: |
| ![img](http://qmplusimg.henrongyi.top/qq.jpg) |

### 微信交流群

|                       微信                       |
| :----------------------------------------------: |
| ![img](http://qmplusimg.henrongyi.top/qrjjz.png) |
...
[![img](https://contrib.rocks/image?repo=flipped-aurora/gin-vue-admin)](https://github.com/flipped-aurora/gin-vue-admin/graphs/contributors)

## 9. 捐赠

如果你觉得这个项目对你有帮助，你可以请作者喝饮料 🍹 [点我](https://www.gin-vue-admin.com/coffee/index.html)
