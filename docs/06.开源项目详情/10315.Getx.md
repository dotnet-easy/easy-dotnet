...
::: 
[![img](https://raw.githubusercontent.com/jonataslaw/getx-community/master/get.png)](https://raw.githubusercontent.com/jonataslaw/getx-community/master/get.png)

[![pub package](https://camo.githubusercontent.com/52582226324baf59812a91eacb2c8e3e81ebb9d6a02fd3252387c3e545c5c31a/68747470733a2f2f696d672e736869656c64732e696f2f7075622f762f6765742e7376673f6c6162656c3d67657426636f6c6f723d626c7565)](https://pub.dev/packages/get) [![popularity](https://camo.githubusercontent.com/14cd3cc1127fc4b3640ed992151f7389afd9e7e9fdca9d4e86802eafbeb1d646/68747470733a2f2f6261646765732e6261722f6765742f706f70756c6172697479)](https://pub.dev/packages/sentry/score) [![likes](https://camo.githubusercontent.com/f952e544581b25cf202a7201cd7703330b25580dd6bc9a57be59a5e0aa9fa105/68747470733a2f2f6261646765732e6261722f6765742f6c696b6573)](https://pub.dev/packages/get/score) [![pub points](https://camo.githubusercontent.com/84957d0eef0f35d23f69fb5693438eb2684e8620aa7649b39ebf34751c087de4/68747470733a2f2f6261646765732e6261722f6765742f707562253230706f696e7473)](https://pub.dev/packages/get/score) [![building](https://github.com/jonataslaw/get/workflows/build/badge.svg)](https://github.com/jonataslaw/get/workflows/build/badge.svg) [![style: effective dart](https://camo.githubusercontent.com/3edde70453db4e1ac4289d2f845fe644c97629391eb9e7431c4f1c5721734ae0/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f7374796c652d6566666563746976655f646172742d3430633466662e737667)](https://pub.dev/packages/effective_dart) [![Discord Shield](https://camo.githubusercontent.com/89fd56a6e250508998c2c3e9708d60bc58074d6803aa3e552d58c91fb8ea6fd0/68747470733a2f2f696d672e736869656c64732e696f2f646973636f72642f3732323930303838333738343037333239302e7376673f6c6f676f3d646973636f7264)](https://discord.com/invite/9Hpt99N) [![Get on Slack](https://camo.githubusercontent.com/552ad37eb845d5e54e1bef55f3ea7adb185f36c845a6b676eec85e97122b2fcd/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f736c61636b2d6a6f696e2d6f72616e67652e737667)](https://communityinviter.com/apps/getxworkspace/getx) [![Telegram](https://camo.githubusercontent.com/f9c1c60f9b40bd4e8735a0a4e0e56039c54c336313cb94c1c115c6a419af3a63/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f636861742d6f6e25323054656c656772616d2d626c75652e737667)](https://t.me/joinchat/PhdbJRmsZNpAqSLJL6bH7g) [![Awesome Flutter](https://camo.githubusercontent.com/503db17bcdc3d8ef4b44436324a4c03d2f00fa9b606b4c23b98761b80f8033f5/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f417765736f6d652d466c75747465722d626c75652e7376673f6c6f6e6743616368653d74727565267374796c653d666c61742d737175617265) ](https://github.com/Solido/awesome-flutter)[![Buy Me A Coffee](https://camo.githubusercontent.com/be9e49f165b0fa74c910ec2cb7f5b77e5c634d02bce0e1b42608de0844811dda/68747470733a2f2f692e696d6775722e636f6d2f615636444441372e706e67)](https://www.buymeacoffee.com/jonataslaw)

[![img](https://raw.githubusercontent.com/jonataslaw/getx-community/master/getx.png)](https://raw.githubusercontent.com/jonataslaw/getx-community/master/getx.png)
...
- 第二步： 创建你的业务逻辑类，并将所有的变量，方法和控制器放在里面。 你可以使用一个简单的".obs "使任何变量成为可观察的。
...
- 第三步: 创建你的界面，使用StatelessWidget节省一些内存，使用Get你可能不再需要使用StatefulWidget。
...
**关于状态管理更深入的解释请查看[这里](https://github.com/jonataslaw/getx/blob/master/documentation/zh_CN/state_management.md)。在那里你将看到更多的例子，以及简单的状态管理器和响应式状态管理器之间的区别** 。
...
用别名导航到新页面。查看更多关于命名路由的详细信息[这里](https://github.com/jonataslaw/getx/blob/master/documentation/zh_CN/route_management.md#navigation-with-named-routes)
...
**关于依赖管理的更深入解释请看[此处](https://github.com/jonataslaw/getx/blob/master/documentation/zh_CN/dependency_management.md)** 。
...
翻译被保存为一个简单的键值字典映射。 要添加自定义翻译，请创建一个类并扩展 `翻译`。
...
你可以为 "Get "创建_全局设置。只需在推送任何路由之前将 `Get.config`添加到你的代码中。 或者直接在你的 `GetMaterialApp`中做。
...
你可以选择重定向所有来自 `Get`的日志信息。 如果你想使用你自己喜欢的日志包，并想查看那里的日志。
...
这些Widgets允许您管理一个单一的值，并保持状态的短暂性和本地性。 我们有Reactive和Simple两种风格。 例如，你可以用它们来切换 `TextField`中的obscureText，也许可以创建一个自定义的可扩展面板（Expandable Panel），或者在"Scaffold "的主体中改变内容的同时修改 `BottomNavigationBar`中的当前索引。
...
类似于[`ValueBuilder`](https://github.com/jonataslaw/getx/blob/master/README.zh-cn.md#valuebuilder)，但这是Reactive版本，你需要传递一个Rx实例（还记得神奇的.obs吗？自动更新......是不是很厉害？）
...
> `.obs`的属性**是**实际值，不要搞错了! 我们避免了变量的类型声明，因为Dart的编译器足够聪明，而且代码 看起来更干净，但：
...
即使 `message` _prints_实际的字符串值，类型也是 **RxString** ！ 所以，你不能做 `message.substring( 0, 4 )`。 你必须在_observable_里面访问真正的 `value`。 最常用的方法是".value", 但是你也可以用...
...
大多数人都不知道这个Widget，或者完全搞不清它的用法。 这个用例非常少见且特殊：它 "缓存 "了一个Controller，由于*cache*，不能成为一个 "const Stateless"（因为*cache*，所以不能成为一个 `const Stateless`）。
...
```
Get.create(()=>Controller())` 会在每次调用时生成一个新的 `Controller` `Get.find<Controller>()
```
...
这个类就像一个 "GetxController"，它共享相同的生命周期（"onInit()"、"onReady()"、"onClose()"）。 但里面没有 "逻辑"。它只是通知**GetX**的依赖注入系统，这个子类**不能**从内存中删除。

所以这对保持你的 "服务 "总是可以被 `Get.find()`获取到并保持运行是超级有用的。比如 `ApiService`，`StorageService`，`CacheService`。
...
为什么要做这样的改变？ 通常情况下，可能需要通过一个参数，或者一个登录令牌来决定显示哪个页面。 将页面插入到一个函数中，大大降低了RAM的消耗，因为自从应用程序启动后，路由将不会在内存中分配。
...
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| [![Get on Slack](https://camo.githubusercontent.com/552ad37eb845d5e54e1bef55f3ea7adb185f36c845a6b676eec85e97122b2fcd/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f736c61636b2d6a6f696e2d6f72616e67652e737667)](https://communityinviter.com/apps/getxworkspace/getx) | [![Discord Shield](https://camo.githubusercontent.com/89fd56a6e250508998c2c3e9708d60bc58074d6803aa3e552d58c91fb8ea6fd0/68747470733a2f2f696d672e736869656c64732e696f2f646973636f72642f3732323930303838333738343037333239302e7376673f6c6f676f3d646973636f7264)](https://discord.com/invite/9Hpt99N) | [![Telegram](https://camo.githubusercontent.com/f9c1c60f9b40bd4e8735a0a4e0e56039c54c336313cb94c1c115c6a419af3a63/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f636861742d6f6e25323054656c656772616d2d626c75652e737667)](https://t.me/joinchat/PhdbJRmsZNpAqSLJL6bH7g) |
