---
title: wechat-backup
date: 2023-04-22 13:05:03
permalink: /pages/10231/
sidebar: false
article: false
---
::: note 开源地址
Github：[https://github.com/greycodee/wechat-backup](https://github.com/greycodee/wechat-backup)
::: 
## 效果图

![img](/img/open/10231/e8d10c0e8f0c2d3557bc109622e31f9e.png)
...
> 我这边通过系统备份然后 bak 文件解包-解压后，文件路径在：apps/com.tencent.mm/r/MicroMsg/ 下，大家可以参考一下 如果通过手机系统自带的备份来获取数据时，解密 DB 的密码可以通过这篇文章的方法一来获取： [获取 DB 解密密码](https://greycode.top/posts/android-wechat-bak/#获取-db-访问密码)
